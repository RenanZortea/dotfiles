...
hl.bind(mainMod .. " + ALT + E", hl.dsp.exec_cmd("~/.config/ml4w/settings/filemanager"), { description = "Open the filemanager" })
...
local dvorak_keys = { "A", "O", "E", "U", "I", "D", "H", "T", "N", "S" }

-- Move active window to a workspace with mainMod + SHIFT + [dvorak home row]
for i = 1, 10 do
    local key = dvorak_keys[i]
    if is_fr then
        key = fr_keys[i]
    end
...
hl.bind(mainMod .. " + CTRL + F", hl.dsp.window.float({ action = "toggle" }), { description = "Toggle Floating" })
...
hl.bind(mainMod .. " + CTRL + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-animations.sh"), { description = "Toggle animations" })
...
hl.bind(mainMod .. " + ALT + B", hl.dsp.exec_cmd("qs ipc call statusbar reload"), { description = "Reload statusbar" })
...
hl.bind(mainMod .. " + CTRL + H", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-hyprsunset"), { description = "Toggle Hyprsunset" })
...
hl.bind(mainMod .. " + GRAVE",         hl.dsp.workspace.toggle_special("magic"), { description = "Toggle special workspace magic" })
hl.bind(mainMod .. " + SHIFT + GRAVE", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-scratchpad-window"), { description = "Toggle window in/out of special workspace magic" })
